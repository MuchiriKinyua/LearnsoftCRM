  ...
  $.extend(Datepicker.prototype, {
    ...
    _determineDate: function(inst, date, defaultDate) {
      var offsetNumeric = function(offset) {
        ...
        var date2 = (offset.toLowerCase().match(/^c/) ? $.datepicker._getDate(inst) : null) || /* @__PURE__ */ new Date(), year = date2.getFullYear(), month = date2.getMonth(), day = date2.getDate(), pattern = /([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, matches = pattern.exec(offset);
        while (matches) {
          switch (matches[2] || "d") {
            case "d":
            case "D":
    ...
    _generateHTML: function(inst) {
      ...
      if (this._canAdjustMonth(inst, -1, drawYear, drawMonth)) {
        prev = $("<a>").attr({
          ...
          $("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (isRTL ? "e" : "w")).text(prevText)
        )[0].outerHTML;
      ...
      if (this._canAdjustMonth(inst, 1, drawYear, drawMonth)) {
        next = $("<a>").attr({
          ...
          $("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (isRTL ? "w" : "e")).text(nextText)
        )[0].outerHTML;
      } else if (hideIfNoPrevNext) {
        next = "";
      } else {
        next = $("<a>").attr({
          ...
          $("<span>").attr("class", "ui-icon ui-icon-circle-triangle-" + (isRTL ? "w" : "e")).text(nextText)
        )[0].outerHTML;
      }
...
jquery-ui/ui/widgets/datepicker.js:
   ...
   *)
*/
//# sourceMappingURL=jquery-ui_ui_widgets_datepicker.js.map
